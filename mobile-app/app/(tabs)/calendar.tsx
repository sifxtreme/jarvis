...
const styles = StyleSheet.create({
  ...
  eventCard: { flexDirection: 'row', borderRadius: 12, borderWidth: 1, overflow: 'hidden' },
  eventStripe: { width: 4 },
  ...
  descriptionText: { fontSize: 12, marginTop: 2 },
  calendarName: { fontSize: 12, fontWeight: '500', marginTop: 2 },
