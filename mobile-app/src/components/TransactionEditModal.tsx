...
const styles = StyleSheet.create({
  ...
  readOnlyField: { borderWidth: 1, borderRadius: 8, paddingHorizontal: 14, paddingVertical: 12 },
  readOnlyText: { fontSize: 15 },
  dateRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  dateBtn: { borderWidth: 1, borderRadius: 8, padding: 10 },
  dateDisplay: { flex: 1, borderWidth: 1, borderRadius: 8, paddingHorizontal: 14, paddingVertical: 12, alignItems: 'center' },
  dateText: { fontSize: 15, fontWeight: '500' },
  pickerButton: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 1, borderRadius: 8, paddingHorizontal: 14, paddingVertical: 12 },
  pickerText: { fontSize: 15 },
  pickerList: { borderWidth: 1, borderRadius: 8, overflow: 'hidden' },
