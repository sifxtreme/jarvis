        ...
        <el-menu :default-openeds="['1']">
          <form @submit.prevent="searchAPI">
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                <el-switch v-model="showHidden" inactive-text="SHOW HIDDEN?" />
                <br />
                <br />
                <el-switch v-model="showNeedsReview" inactive-text="NEEDS REVIEW?" />
              </el-menu-item-group>
              <el-menu-item-group>
      ...
      <el-container>
        ...
        <el-main>
          ...
          >
            <el-table-column sortable prop="plaid_name" label="Plaid Name">
              <template slot-scope="scope">
                ...
                <el-input v-if="scope.row.editMode" v-model="scope.row.plaid_name" />
              </template>
            </el-table-column>
            ...
            <el-table-column sortable prop="merchant_name" label="Merchant Name">
              <template slot-scope="scope">
                ...
                <el-input v-if="scope.row.editMode" v-model="scope.row.merchant_name" />
              </template>
            </el-table-column>
            ...
            <el-table-column sortable prop="category" label="Category">
              <template slot-scope="scope">
                ...
                <el-input v-if="scope.row.editMode" v-model="scope.row.category" />
              </template>
            </el-table-column>
            ...
            <el-table-column sortable prop="amount" label="Amount">
              <template slot-scope="scope">
                ...
                <el-input v-if="scope.row.editMode" v-model="scope.row.amount" type="number" />
              </template>
            </el-table-column>
            ...
            <el-table-column sortable prop="source" label="Source">
              <template slot-scope="scope">
                ...
                <el-input v-if="scope.row.editMode" v-model="scope.row.source" />
              </template>
            </el-table-column>
            ...
            <el-table-column label="Metadata">
              <template slot-scope="scope">
                ...
                <span v-if="scope.row.editMode">
                  <el-switch v-model="scope.row.hidden" />Hidden
                  <br />
                  <el-switch v-model="scope.row.reviewed" />Reviewed
                </span>
              </template>
            </el-table-column>
          ...
          <el-table border stripe :data="categorySums">
            <el-table-column width="150" sortable prop="name" label="Name" />
